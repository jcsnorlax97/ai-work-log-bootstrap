...
Create a safe, summarized capture of the current work session and save it to the AI work-log vault inbox. This skill is intended for Claude Code, Codex, or another AI coding assistant.
